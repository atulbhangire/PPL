...
define("SITE_ADDRESS561",config('config_path_vars.site_address'));

class OrderDetailsControllerRO extends Controller
{
	...
	public function display($zone_code)
	{
		if(Session::get('is_admin'))
		{
			...
			return view('Admin.OrderDetailsRO.indexOrderDetailsRO', compact('order_details'));
		}
		else
		{
			return redirect('/');
...
////////////////////////////////////////////////////////////////////////////////////////////
			...
			return view('Admin.OrderDetailsRO.editOrdersRO', compact('order_details'));
		}
		else
		{
			return redirect('/');
	...
	public function send_user_email_for_order_activated( $order_id = null )
    {
        ...
        $url = SITE_ADDRESS561 . "/order-info";
