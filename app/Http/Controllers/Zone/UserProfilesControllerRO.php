...
class UserProfilesControllerRO extends Controller
{
	...
	public function display($zone_code)
	{
		if(Session::get('is_admin'))
		{
			...
			return view('Admin.UserProfilesRO.indexUserProfilesRO', compact('user_profiles'));
		}
		else
		{
			return redirect('/');
	...
	public function edit($zone_code, $id)
    {
    	if(Session::get('is_admin'))
		{
			...
			return view('Admin.UserProfilesRO.editUserProfilesRO');
		}
		else
		{
			return redirect('/');
